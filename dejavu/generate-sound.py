...
def main():
    ...
    parser.add_argument('-c', '--channels', help="Number of channels to produce", default=1, type=int)
    ...
    parser.add_argument('-t', '--time', help="Duration of the wave in seconds.", default=10, type=int)
    parser.add_argument('-a', '--amplitude', help="Amplitude of the wave on a scale of 0.0-1.0.", default=0, type=float)
    parser.add_argument('-f', '--frequency', help="Frequency of the wave in Hz", default=120.0, type=float)
