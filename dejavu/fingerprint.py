...
######################################################################
# This is the minimum number of maxima to find whether a file is a noise or not
LOCAL_MAXIMA_THRESHOLD= 7.0
...
# refactor to improve the plot
# based on https://github.com/oneyoung/dejavu/commit/ce082056954b0ac81fa37a9de58af8a9aad303fb
...
def fingerprint(channel_samples, Fs=DEFAULT_FS,
                ...
                plot=False,
                local_maxima_threshold = LOCAL_MAXIMA_THRESHOLD):
    """
    ...
    minimun_local_maxima =  (len(channel_samples)/Fs) * local_maxima_threshold
    print 'minimunm local maxima'
    print minimun_local_maxima
    if (len(local_maxima) <= minimun_local_maxima ):

        raise ValueError('File contains no signal')
    # sys.exit()
    # return hashes
