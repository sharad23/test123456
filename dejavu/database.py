...
class Database(object):
    ...
    FIELD_REAL_TIME = "real_time"
    FIELD_MATCHES_ID = "idmatches"
    FIELD_FROM_SONG_TIME = "from_song_time"
    FIELD_TO_SONG_TIME = "to_song_time"
...
def get_database(database_type=None):
    ...
    # print set(Database.__subclasses__())
    # sys.exit()
...
from . import database_pgsql
#import dejavu.database_mongodb
